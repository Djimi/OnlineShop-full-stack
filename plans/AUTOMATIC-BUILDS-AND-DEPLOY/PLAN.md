...
| ✅ Candidate evidence failed after green staging E2E because `referencing` was absent on the runner | Candidate-evidence now installs the pinned release-contract requirements before its producer-set validation |
